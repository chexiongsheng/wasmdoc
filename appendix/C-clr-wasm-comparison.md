...
> **wasm3 源码参考**：[m3_compile.c - c_operations](../wasm3/source/m3_compile.c#L2260) — 完整的操作码映射表（对比 CLR 的 ~220 条 CIL 指令，Wasm 有 ~170 条 MVP 指令）；[m3_exec.h](../wasm3/source/m3_exec.h) — 所有指令的运行时实现。
