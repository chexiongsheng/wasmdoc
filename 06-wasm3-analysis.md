...
// Source: m3_exec.h — generated by d_m3CommutativeOpFunc_i(i32, Add, OP_ADD_32)
d_m3Op(i32_Add_rs)
{
...
```c
// d_m3CommutativeOpMacro expands to:
...
// When the value is in register, the compiler emits SetSlot (m3_exec.h#L951, by d_m3SetRegisterSetSlot macro):
d_m3Op (SetSlot_i32)
{
